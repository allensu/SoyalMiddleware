...
class SoyalMessageServer extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'soyal:soyal-message-server {action}';
     ...
     * @var string
     */
    protected $description = 'Start A Soyal Message Server';
    ...
    private function start()
    {
        ...
        $this->server = new Worker("tcp://0.0.0.0:8031");
        // 启动4个进程对外提供服务
        $this->server->count = 4;
